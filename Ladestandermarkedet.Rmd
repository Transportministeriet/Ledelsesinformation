...
Fordelingen blandt de 3 typer af ladeefekt er pr. `r as.character(seneste_md)` 
...
Siden august 2022 er antallet af offentligt tilgængelige ladepunkter dog steget relativt mere end antallet af elbiler, og der har derfor været en faldende tendens i antallet af elbiler pr. offentligt ladepunkt. Ved udgangen af `r as.character(seneste_md)` 2023 var der `r as.character(tail(elbil_lader_komgrp$el_bil_pr_outlets,1))` elbiler pr. offentligt tilgængelige ladepunkt.
