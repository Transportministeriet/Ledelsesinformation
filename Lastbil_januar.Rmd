...
bestand_data_1 %>% 
  ...
  mutate(x_axis = case_when(
    AAR == "2025" ~ str_c("Ultimo ", seneste_md, " ", nyeste_aar),  # Replace Ultimo 2025 with Ultimo seneste_md nyeste_aar
    AAR == "2024" ~ str_c("Ultimo ", AAR),  # Keep Ultimo 2024
    str_detect(AAR, "\\(") ~ str_c("Ultimo ", seneste_md, " ", nyeste_aar),  # Ensure other cases follow the same format
    TRUE ~ str_c("Ultimo ", AAR)
  ),
  oprindelse = "Bilstatistik",
  ANTAL,
  .keep = "none") %>%
