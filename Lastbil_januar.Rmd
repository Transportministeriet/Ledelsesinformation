...
hc_legend(reversed = TRUE, 
 ...
 format_chart("<b>Figur 2.1</b> Drivmidlernes andel af nyregistreringer for lette lastbiler", 
              note = "Kilde: Bilstatistik<br>Note: Lette lastibler dækker over lastbiler med en på vægt på 4.250 kg. og nedefter.")
...
figur2_tunge <- nyreg_data_1_tunge |>
 ...
 hc_legend(reversed = TRUE, 
  ...
  format_chart("<b>Figur 2.2</b> Drivmidlernes andel af nyregistreringer for tunge lastbiler", 
              note = "Kilde: Bilstatistik<br>Note: Tunge lastbiler dækker over lastbiler med en vægt over 4.250 kg.")
...
Diesel er stadig det dominernde drivmiddel i bestanden af lastbiler. Bestanden af lastbiler har generelt været svagt stigende siden 1. januar 2021, hvor den samlede bestand var `r bestand_2021`, mens  bestanden primo januar 2025 var `r bestand_seneste` lastbiler. 
...
title = list(text = NULL),
 ...
 pointFormat = "<b>{series.name}</b>: {point.percentage:.1f} pct. ({point.y:,.0f} lastbiler) <br>") %>%
  format_chart("<b>Figur 3.2</b> Udviklingen i den samlede bestand af tunge lastbiler", 
              note = "Kilde: Bilstatisitk<br>Note: Tunge lastbiler dækker over lastbiler med en vægt over 4.250 kg.") %>%   hc_legend(reversed = TRUE, 
            layout = "horizontal", 
            align = "center", 
            verticalAlign = "bottom",
            itemStyle = list(fontSize = "11px"),
...
bestand_data_1 %>% 
  ...
  format_chart(str_glue("<b>Figur 4.</b> Status for antallet af ellastbiler i 2025 - oberserveret versus forventet"),
               note = "Kilde: Bilstatistik")
...
map(udvalgte_kat, ~{nyreg_data_underkat |>
  ...
  format_chart(str_glue("<b>{str_replace_all(.x, c('_'=' ', 'OE'='Ø', 'AA'='Å', 'AE'='Æ')) %>% str_to_sentence()}<b>"), note="Kilde: Bilstatistik")}) |> 
...
map(udvalgte_kat, ~{bestand_data_underkat |> 
 ...
 hc_legend(
  ...
  format_chart(str_glue("<b>{str_replace_all(.x, c('_'=' ', 'OE'='Ø', 'AA'='Å', 'AE'='Æ')) %>% str_to_sentence()}<b>"),note="Kilde: Bilstatisitk")}) |> 
  hw_grid(rowheight = 400) %>% htmltools::browsable()
