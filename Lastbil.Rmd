...
rest <-elbestand_seneste - KF_tal$ANTAL[[1]]  
  
```

Jævnfør Klimastatus og -fremskrvining 2024 forventes der at være cirka `r KF_tal$ANTAL[[1]]` elektriske lastbiler i Danmark ved udgangen af 2024. Differencen mellem det nuværende  og det forventede antal elektriske lastbiler ved udgangen af året er således `r rest` lastbiler, jf. figur 4.
