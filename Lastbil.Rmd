...
Det er dog særligt lette lastbiler, med en vægt på 4.250 kg. og under der omstilles. I `r as.character(nyeste_aar)` har ellastbiler udgjort `r elsalg_seneste_lette/totalsalg_seneste_lette*100` pct. af nyregistreringerne for lette lastbiler, jævnfør figur 2.1. Til sammenligning har ellastbiler i indeværende år udgjort `r elsalg_seneste_tunge/totalsalg_seneste_tunge*100` pct. af nyregistreringerne for lastbiler med en vægt over 4.250 kg., jævnfør figur 2.2.
...
figur2_tunge <- nyreg_data_1_tunge |> 
 ...
 hc_legend(reversed = TRUE, 
    ...
    hc_chart(marginBottom = 110)  %>%# Reduce font size if necessary %>%  # Adding spacing between items
  hc_tooltip(shared = TRUE,
                        pointFormat = "<b>{series.name}</b>: {point.percentage:.1f} pct. (<b>{point.antal:,.0f}</b> lastbiler)<br>") %>%
...
Omend bestanden af tunge lastbiler er væsentligt større end bestanden af lette lastbiler, er det værd at bemærke, at bestanden af lette lastbiler har været stigende siden 2022. Ellastbiler udgjorde ved udgangen af oktober måned `r elbestand_seneste_lette/bestand_seneste_lette*100` pct. af den samlede bestand af lette lastbiler, jævnfør figur 3.1. I modsætning hertil udgjorde ellastbiler blot `r elbestand_seneste_tunge/bestand_seneste_tunge*100` pct. af den samlede bestand af tunge lastbiler, jævnfør figur 3.2.
