...
## til pct.vis ændring under figur 2 ##

base_2019  <- unname(totalbestand["I hus 2019"] + totalbestand["I erh 2019"])
latest <- unname(totalbestand[str_glue("I hus {t_sidste_md} {nyeste_aar}")] + totalbestand[str_glue("I erh {t_sidste_md} {nyeste_aar}")])
...
Den samlede bestand var ultimo 2019 `r comma(base_2019, big.mark=".", decimal.mark=",")` varebiler. Fra ultimo 2019 til `r t_sidste_md` `r nyeste_aar` er bestanden faldet med `r round((1 - latest/base_2019)*100, 1)` pct., så den danske bestand af varebiler ultimo `r t_sidste_md` var `r comma(latest, big.mark=".", decimal.mark=",")` varebiler. Ultimo `r t_sidste_md` `r nyeste_aar` udgjorde elvarebiler `r round(((elbestand[str_glue("I hus {t_sidste_md} {nyeste_aar}")] + elbestand[str_glue("I erh {t_sidste_md} {nyeste_aar}")]) / latest) * 100, 1)` pct. af den samlede bestand.
...
Jævnfør Klimastatus og -fremskrivning 2026 forventes der ved udgangen af `r nyeste_aar` `r KF_tal$INDHOLD[[1]]` elvarebiler i Danmark. Bestanden ultimo `r str_remove_all(DST_tal$x_axis[[2]], " observeret")` var `r DST_tal$INDHOLD[[2]]` elvarebiler, jf. figur 4.
...
bind_rows(DST_tal, KF_tal) |> 
  ...
  trm_hc_format(str_glue("<b>Figur 4.</b> Status for antallet af elvarebiler i {nyeste_aar}"),
                note = "Kilde: Danmarks Statistik & Klimastatus og -fremskrivning 2026
