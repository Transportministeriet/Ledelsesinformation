...
figur6.2 <- data_nysalg_erhverv_1 |>
  filter(!AAR %in% c("2018", "2019"), DRIV != "Øvrige drivmidler") |># Exclude rows where AAR CONTATINS "9"
...
figur7.1 <- data_bil_hus_1_ny |> 
  ...
  trm_hc_format("<b>Figur 6.1</b> Udviklingen i den samlede bestand af varebiler i husholdningen",
...
figur7.2 <- data_bil_erhverv_1_ny |> 
  ...
  hc_tooltip(shared=TRUE,
             pointFormat = "<b>{series.name}</b>: {point.percentage:.1f} pct. ({point.y:,.0f} varebiler) <br>") %>%
  trm_hc_format("<b>Figur 6.2</b> Udviklingen i den samlede bestand af varebiler i erhvervet",
                note = str_glue("Kilde: Danmarks Statistik"))%>% 
  hc_legend(reversed = TRUE, 
            layout = "horizontal", 
            align = "center", 
