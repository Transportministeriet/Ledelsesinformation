...
KF_salg <- read_excel(str_c(sti_kf, "/", "kf24_dataark_-_transport.xlsx"),
           sheet = "Salg", skip =4) %>% 
...
KF_bestand <- read_excel(str_c(sti_kf, "/", "kf24_dataark_-_transport.xlsx"),
...
Jævnfør Klimastatus og -fremskrvining 2024 forventes der at være cirka `r KF_tal$ANTAL[[2]]` elektriske lastbiler i Danmark ved udgangen af 2024. Differencen mellem det nuværende  og det forventede antal elektriske lastbiler ved udgangen af året er således `r rest` lastbiler, jf. figur 4.
