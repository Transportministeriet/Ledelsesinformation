...
```{r}
#FIGUR 1. Udvikling i nyregistreringer af personbiler fordelt på drivmiddel
...
data_nysalg_2_stjerne |> 
  ...
  trm_hc_format("<b>Figur 1.</b> Udvikling i nyregistreringer af personbiler fordelt på drivmiddel",
...
```{r}
# Figur 2. Drivmidlernes andel af nyregistreringer for personbiler
...
data_nysalg_1_stjerne |> 
  ...
  hc_legend(reversed =TRUE) %>% 
  hc_tooltip(shared = TRUE) %>% 
  trm_hc_format("<b>Figur 2.</b> Drivmidlernes andel af nyregistreringer for personbiler",
               note = str_glue("Kilde: Danmarks Statistik<br>{stjerne_tekst}"))
...
#              ) %>% 
 hc_xAxis(
  ...
  hc_legend(reversed =TRUE) %>% 
  trm_hc_format("<b>Figur 3.</b> Bestand af personbiler",
...
Jævnfør Klimastatus og -fremskrivning 2024 vil der ved udgangen af 2025 være `r KF_tal$INDHOLD[[2]]` elbiler i Danmark. Bestanden pr. `r str_remove_all(DST_tal$x_axis[[2]], " observeret")` var `r DST_tal$INDHOLD[[2]]` elbiler, jf. figur 4. Differencen mellem det nuværende antal elbiler og det forventede antal elbiler ved udgangen af 2025 er således `r rest`.

```{r}
#Figur 4. Status for antallet af elbiler i nyeste aar
...
```{r}
# Figur 5. Udvikling i antallet af biler fra januar til nyeste måned
...
data_fig_4_stjerne |> 
  ...
  hc_xAxis(title = list(text = NULL)) %>%
  trm_hc_format(str_glue("<b>Figur 5.</b> Udvikling i antallet af biler fra ultimo januar til ultimo {format(ISOdate(2000, as.numeric(Nummer_sidste_md), 1), '%B')}" ),
               note = str_glue("Kilde: Danmarks Statistik<br>{stjerne_tekst}"))
