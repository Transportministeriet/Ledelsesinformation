...
data_nysalg_2_stjerne |> 
  ...
  format_chart("<b>Figur 1.</b> Udvikling i nyregistreringer af personbiler fordelt på drivmiddel",
...
data_nysalg_1_stjerne |> 
  ...
  hc_legend(reversed =TRUE) %>% 
  hc_tooltip(shared = TRUE) %>% 
  format_chart(titel =str_glue("<b>Figur 2.</b> Drivmidlernes andel af nyregistreringer for personbiler" ), "Kilde: Danmarks Statistik<br>*År til dato")
...
data_fig_4_stjerne |> 
  ...
  format_chart(titel =str_glue("<b>Figur 5.</b> Udvikling i antallet af biler fra januar til {format(ISOdate(2000, as.numeric(Nummer_sidste_md), 1), '%B')}" ),
               note = "Kilde: Danmarks Statistik<br>*År til dato")
